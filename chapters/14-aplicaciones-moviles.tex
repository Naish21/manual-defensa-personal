...
\begin{consejo}
Ninguna app sustituye a la atención al entorno. El móvil en la mano mirando la pantalla te pone en \enquote{código blanco}; el móvil configurado en el bolsillo, con SOS y Guardián listos, es un arma defensiva.
\end{consejo}
